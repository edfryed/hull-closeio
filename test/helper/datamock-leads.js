...
function getLeadListResponseForPagination(page, size, total) {
  ...
  for (let index = page * size; index < ((page * size) + size); index++) { // eslint-disable-line no-plusplus
    const elmt = {
      status_id: "stat_1ZdiZqcSIkoGVnNOyxiEY58eTGQmFNG3LPlEVQ4V7Nk",
      status_label: "Potential",
      tasks: [],
      display_name: `Demo ${index} Co. (Sample Lead)`,
      addresses: [],
      contacts: [
        {
          name: "John Mayaer",
          ...
          emails: [
            {
              type: "office",
              email_lower: "johnmayaer@close.io",
              email: "johnmayaer@close.io"
            }
          ],
          updated_by: "user_04EJPREurd0b3KDozVFqXSRbt2uBjw3QfeYa7ZaGTwI"
        }
      ...
      date_updated: "2013-02-06T20:53:01.977000+00:00",
      description: "",
      html_url: `https://app.close.io/lead/lead_IIDHIStmFcFQZZP0BRe99V1MCoXWz2PGCm6EDmR9${index}/`,
      created_by: null,
      organization_id: "orga_bwwWG475zqWiQGur0thQshwVXo8rIYecQHDWFanqhen",
      url: null,
      opportunities: [
        {
          id: "oppo_8eB77gAdf8FMy6GsNHEy84f7uoeEWv55slvUjKQZpJt",
          organization_id: "orga_bwwWG475zqWiQGur0thQshwVXo8rIYecQHDWFanqhen",
          lead_id: `lead_IIDHIStmFcFQZZP0BRe99V1MCoXWz2PGCm6EDmR9${index}`,
          lead_name: `Demo ${index} Co. (Sample Lead)`,
          status_id: "stat_4ZdiZqcSIkoGVnNOyxiEY58eTGQmFNG3LPlEVQ4V7Nk",
          status_label: "Active",
          status_type: "active",
          value: 50000,
          ...
          date_won: null,
          confidence: 75,
          note: "John needs new CRM software.",
          user_id: "user_scOgjLAQD6aBSJYBVhIeNr6FJDp8iDTug8Mv6VqYoFn",
          user_name: "P F",
          contact_id: null,
          created_by: null,
      ...
      updated_by: "user_04EJPREurd0b3KDozVFqXSRbt2uBjw3QfeYa7ZaGTwI",
      date_created: "2013-02-01T00:54:51.333000+00:00",
      id: `lead_IIDHIStmFcFQZZP0BRe99V1MCoXWz2PGCm6EDmR9${index}`,
      name: `Demo ${index} Co. (Sample Lead)`
    };
    result.data.push(elmt);
  }
