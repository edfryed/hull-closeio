const SHARED_MESSAGES = {
  ...
  MAPPING_NOOUTBOUNDFIELDS: () => {
    return {
      ...
      message: "The mapping utility hasn't been initialized with any field mappings.",
      level: "Error",
      channel: "Operation",
      category: "DataTransformation"
    };
  ...
  OPERATION_SKIP_NOMATCHACCOUNTSEGMENTS: () => {
    return {
      ...
      message: "The Hull account is not part of any whitelisted segment and won't be synchronized with close.io.",
      level: "Information",
      channel: "Operation",
      category: "DataFlow"
    };
  ...
  OPERATION_SKIP_NOMATCHACCOUNTSEGMENTSUSER: () => {
    return {
      ...
      message: "The linked Hull account is not part of any whitelisted segment, the user won't be synchronized as contact to close.io.",
      level: "Information",
      channel: "Operation",
      category: "DataFlow"
    };
  ...
  OPERATION_SKIP_NOLINKEDACCOUNT: () => {
    return {
      ...
      message: "The Hull user is not linked to an account; cannot create a contact in close.io without a lead.",
      level: "Information",
      channel: "Operation",
      category: "DataFlow"
    };
